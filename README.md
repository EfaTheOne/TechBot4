...
-Regulator (SOT-223) PCBA Number: C6186
(Regulator	AMS1117-3.3 (SOT-223)	1	C6186	Steps down 5V to 3.3V for ESP32)
-Capacitor (0603, X5R, 10V) PCBA Number: C96446
(Capacitor	22µF (0603, X5R, 10V)	2	C96446	IP5306 Input/Output Filtering))
-Capacitor (0603, X5R, 16V) PCBA Number: C19702
(Capacitor	10µF (0603, X5R, 16V)	3	C19702	AMS1117 In/Out, ESP32 Power)
-Capacitor 
(Capacitor	0.1µF (0603, X7R, 50V)	1	C14663	ESP32 Decoupling / Filter)
(Resistor	5.1kΩ (0603, 1%)	2	C23178	USB-C CC Pin Pull-downs (Required for C-to-C charging))
(Resistor	1kΩ (0603, 1%)	1	C21190	LED limiting or EN Pull-up (See notes))
(USB Port	USB Type-C 16-Pin (SMD)	1	C165948	Charging Input (Korean Hroparts))
(Connector	JST-PH 2-Pin (Vertical SMD)	1	C396123	Battery Connector)
(ESP32	ESP32-WROOM-32-N8	1	C529582	Microcontroller (User specified))
